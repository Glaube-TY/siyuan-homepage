import { getCalendarDateMetadata, type CalendarDateMetadata } from "@/utils/calendar-metadata";
...
export type EnhancedDiaryCalendarMetadata = CalendarDateMetadata;
    ...
    return Promise.all(
        days.map(async (date) => {
            ...
            return {
                ...
                metadata: getCalendarDateMetadata(date),
                hasDiary: !!doc,
                docId: doc?.id,
                newTaskCount,
                migratedTaskCount,
