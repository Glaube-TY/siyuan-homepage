...
<div
    ...
    style={`--homepage-banner-title-color: ${classic.bannerTitleColor}; --homepage-banner-status-color: ${classic.bannerStatusColor}; --homepage-banner-button-color: ${classic.bannerButtonColor};`}
>
