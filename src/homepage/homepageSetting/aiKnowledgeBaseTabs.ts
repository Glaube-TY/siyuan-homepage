export type AiKnowledgeBaseSubTab = "models" | "entries" | "status" | "selection" | "webSearch" | "mcpServer" | "workbenches" | "memory" | "automation";
...
export const AI_KNOWLEDGE_BASE_SUB_TABS: ReadonlyArray<{
    ...
    { id: "mcpServer", label: "MCP 服务", requiresAdvanced: true },
