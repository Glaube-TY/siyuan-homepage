...
export type AssistantChatMessage = {
  ...
  /** 本次运行生成的工作台引用；完整内容由统一工作台仓库存储。 */
  temporaryWorkbenches?: import("../services/agent-workbench/tools/homepage/homepage-workbench.tool").AgentTemporaryWorkbenchReference[];
