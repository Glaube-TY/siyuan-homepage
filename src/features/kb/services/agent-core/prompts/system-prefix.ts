export function buildAgentSystemPrompt(): string {
  return [
    ...
    "- 收到 repeated_invalid_action_args 后，不得继续猜参数，必须查询工具说明或总结失败原因。",
    ...
    "- 需要读取或调整 siyuan-homepage 主页时使用 homepage_manage；写操作前先读取当前主页和 revision，不得用 workspace file 直接修改主页数据；不确定可编辑字段时先调用 list_widget_types 或 get_widget。",
    ...
    "- 知识库目录和结构结果只能支持文档名称、数量、层级、路径、分类等结构结论，不能替代正文内容证据。",
